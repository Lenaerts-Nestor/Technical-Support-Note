...
export const PRODUCTS: Record<string, Product> = {
  ...
  "cp4": {
    ...
    partNumber: "CP4",
    docsUrl: "https://www.crestron.com/Products/Catalog/Control-and-Management/Control-System/Rack-Mount/CP4",
    category: "processors",
    description:
    ...
    specs: [
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "Memory Card", value: "Supports SD and SDHC cards up to 32 GB" },
          { label: "External Storage", value: "Supports USB mass storage devices up to 1 TB" },
        ],
      },
      {
        ...
        fields: [
          ...
          { label: "COM 1", value: "(1) 5-pin 3.5 mm detachable terminal block; bidirectional RS-232/422/485" },
          { label: "COM 2–3", value: "(2) 3-pin 3.5 mm detachable terminal blocks; bidirectional RS-232" },
          { label: "MEMORY", value: "(1) SD memory card slot; accepts SD/SDHC up to 32 GB" },
          { label: "USB", value: "(1) USB Type A (host) for storage" },
          { label: "LAN", value: "(1) 8-pin RJ45; 100/1000Base-TX Ethernet port" },
          {
            label: "NET",
            value:
          ...
          { label: "24VDC", value: "(1) 2.1 x 5.5 mm DC power connector; 24 VDC input; PW-2420RU included" },
          { label: "G", value: "(1) 6-32 screw chassis ground lug" },
          { label: "COMPUTER (front)", value: "(1) USB Type B connector; USB 2.0 computer console port (setup only)" },
        ],
      },
      {
        ...
        fields: [
          ...
          { label: "LAN (rear)", value: "Bicolor green/amber and amber LEDs indicate link status and activity" },
        ],
      },
      {
        title: "Power",
        fields: [
          { label: "Power Options", value: "Power pack or Cresnet (connect only one)" },
          {
            label: "Power Pack (included)",
            value: "Input: 100–240 VAC, 50/60 Hz; Output: 2.5 A @ 24 VDC; Model: PW-2420RU",
          },
          { label: "Cresnet Power Usage", value: "15 W (0.625 A @ 24 VDC) when powered by Cresnet only" },
          { label: "Available Cresnet Power", value: "24 W (1 A @ 24 VDC) when powered by included power pack" },
          { label: "Power Consumption", value: "15 W (not including connected Cresnet devices)" },
        ],
      },
      {
        title: "Environmental",
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "Faceplate", value: "Extruded metal, black finish, polycarbonate label overlay" },
          { label: "Mounting", value: "Freestanding or 1 RU 19-in. rack-mountable (adhesive feet and rack ears included)" },
        ],
      },
      {
        title: "Dimensions",
        fields: [
          ...
          { label: "Width", value: "17.28 in. (439 mm); 19.00 in. (483 mm) with rack ears" },
